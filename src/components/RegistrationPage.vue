        ...
        <section class="container_2">
            ...
            <section class="left">
                ...
                <article class="content">
                    <form v-on:submit.prevent="insertUser" class="form">
                        <section class="inputs">
                            <article>
                                <label for="userFullName">Your Full Name</label>
                                <input class="input" type="text" name="userFullName" id="userFullName" placeholder="Full Name" v-model.lazy="usersObj.userFullName">
                            </article>
                            <article>
                                <label for="userEmail">Your Email</label>
                                <input class="input" type="email" name="userEmail" id="userEmail" placeholder="Email" v-model.lazy="usersObj.userEmail">
                            </article>
                            <article class="passwords">
                                <label for="userPassword">Your Password</label>
                                <input class="input" type="password" name="userPassword" id="userPassword" placeholder="Password" v-model="usersObj.userPassword">
                            </article>
                            <article>
                                <label for="userPhone">Your Phone</label>
                                <input class="input" type="number" name="userPhone" id="userPhone" placeholder="Phone" v-model.lazy="usersObj.userPhone">
                            </article>
                            <article>
